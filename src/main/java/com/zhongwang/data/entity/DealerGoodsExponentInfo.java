...
public class DealerGoodsExponentInfo {
    private Integer id;

    private String companyId;

    private String dealerIndexType;
    ...
    public String getDealerIndexType() {
        return dealerIndexType;
    }

    public void setDealerIndexType(String dealerIndexType) {
        this.dealerIndexType = dealerIndexType == null ? null : dealerIndexType.trim();
    }
